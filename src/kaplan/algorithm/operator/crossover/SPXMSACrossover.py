...
from kaplan.annotation.component_annotation import CrossoverComponent
from kaplan.annotation.decorator import merge_component
from kaplan.annotation.ontology import ontology
from kaplan.core.operator import Crossover
...
SPXMSACrossoverComponent = merge_component(CrossoverComponent, {"hasParameterDistribution": BIGOWL.namespace.hasParameter},
