...
from kaplan.algorithm.operator.crossover.SPXMSACrossover import SPXMSACrossover
from kaplan.algorithm.operator.mutation.TwoRandomAdjacentGapGroupMutation import TwoRandomAdjacentGapGroupMutation
from kaplan.core.solution import MSASolution
from kaplan.problem.msa import MSA
from kaplan.problem.msa_problem.fasta import read_fasta_file_as_list_of_pairs
...
class BAliBASE(MSA):
    ...
    def create_solution(self) -> MSASolution:
        crossover_operator = SPXMSACrossover(probability=1.0)
        mutation_operator = TwoRandomAdjacentGapGroupMutation(probability=1.0)
