...
from kaplan.annotation.component_annotation import DensityEstimatorComponent
from kaplan.annotation.ontology import ontology
from kaplan.util.comparator import SolutionAttributeComparator, Comparator
...
@DensityEstimatorComponent(hasImplementation=TITAN.namespace.ImplementationCrowdingDistance, label=rdflib.Literal('Crowding Distance Density Estimator', datatype=XSD.string))
