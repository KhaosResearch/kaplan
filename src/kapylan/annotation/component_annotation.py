...
from kapylan.annotation.decorator import component
...
SelectionComponent = component(
    TITAN.uri,
    {
        "hasParameter": BIGOWL.namespace.hasParameter,
...
SolutionCreationComponent = component(
    TITAN.uri,
    {
        "hasParameter": BIGOWL.namespace.hasParameter,
        "hasParameterType": BIGOWL.namespace.hasParameter,
...
TerminationComponent = component(
    TITAN.uri,
    {
        "hasParameter": BIGOWL.namespace.hasParameter,
        "hasParameterType": BIGOWL.namespace.hasParameter,
...
DensityEstimatorComponent = component(
    TITAN.uri,
    {
        "hasParameter": BIGOWL.namespace.hasParameter,
        "hasParameterType": BIGOWL.namespace.hasParameter,
...
EvolutionaryAlgorithmComponent = component(
    TITAN.uri,
    {
        "specifiesInputClassSelection": BIGOWL.namespace.specifiesInputClass,
