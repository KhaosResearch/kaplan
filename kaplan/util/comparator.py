...
from kaplan.util.constraint_handling import overall_constraint_violation_degree
from kaplan.core.solution import Solution
...
class MultiComparator(Comparator):
    ...
    def get_comparators(self) -> [Comparator]:
