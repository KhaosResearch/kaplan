...
from kaplan.util.termination_criterion import TerminationCriterion
...
TerminationByEvaluationsComponent = merge_component(TerminationComponent, {"hasParameterNumber": BIGOWL.namespace.hasParameter},
                              {"hasParameterNumber": TITAN.namespace.parameter_max_number_of_evaluations})

@TerminationByEvaluationsComponent(hasImplementation=TITAN.namespace.ImplementationStoppingByEvaluations, label=rdflib.Literal('Stopping By Evaluations', datatype=XSD.string))
